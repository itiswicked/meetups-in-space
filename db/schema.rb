...
ActiveRecord::Schema.define(version: 20151210171941) do
  ...
  add_index "users_meetups", ["meetup_id", "user_id"], name: "index_users_meetups_on_meetup_id_and_user_id", unique: true, using: :btree
